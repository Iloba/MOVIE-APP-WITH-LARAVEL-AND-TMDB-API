...
@section('content')
    <div class="tv-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row sm:mx-auto">
            <img src="{{'https://image.tmdb.org/t/p/w500/'.$tvshow['poster_path']}}" alt="tvshow" class="w-64 md:w-96" style="width: 24rem;">
            <div class="md:ml-24 mt-4 ">
                ...
                <div class="flex items-center text-gray-400 text-sm mt-1">
                    ...
                    <span class="">{{\Carbon\Carbon::parse($tvshow['first_air_date'])->format('M d, Y')}}</span>
                    <span class="mx-2">|</span>
                    <span>
                        ...
                        <div class="container mx-auto lg:px-32 rounded-lg overflow-y-auto">
                            ...
                            <div class="modal-body px-8 py-8">
                                <div class="responsive-container overflow-hidden relative" style="padding-top: 56.25%">
                                    ...
                                    src="https://www.youtube.com/embed/{{$tvshow['videos']['results'][0]['key']}}" style="border:0;" allow="autoplay; encrypted-media" allowfullscreen>
                                </iframe>
                                </div>
                            </div>
                        </div>
